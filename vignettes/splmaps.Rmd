...
pd <- copy(splmaps::norway_lau2_map_b2020_default_dt)
q <- ggplot()
...
```{r fig.height=6, fig.width=6}
pd <- copy(splmaps::norway_lau2_map_b2020_split_dt)
q <- ggplot()
q <- q + geom_polygon(data = pd, aes( x = long, y = lat, group = group), 
                      color="black", fill="white", size=0.1)
q <- q + theme_void()
...
```{r fig.height=6, fig.width=6}
pd <- copy(splmaps::norway_lau2_map_b2020_insert_oslo_dt)
q <- ggplot()
q <- q + geom_polygon(data = pd, aes( x = long, y = lat, group = group), 
                      color="black", fill="white", size=0.1)
...
```{r fig.height=6, fig.width=6}
pd_county <- splmaps::norway_nuts3_map_b2019_default_sf
leaflet::leaflet(
  pd_county,
